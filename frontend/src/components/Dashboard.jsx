...
export default function Dashboard({ data, onReset }) {
    ...
    return (
        <div className="dashboard">
            {/* Greeting */}
            <h2 className="dashboard__greeting">Hey, {name}</h2>
            <p className="dashboard__date">
                Weekly risk assessment &middot; {new Date().toLocaleDateString('en-IN', {
                    weekday: 'long',
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric',
            ...
            <div className={`status-banner ${isProtected ? 'status-banner--protected' : 'status-banner--safe'}`}>
                ...
                <p className="status-banner__text">
                    {isProtected
                        ? `You are protected! ${formatCurrency(payout)} compensation issued.`
                        : 'No payout needed this week. Your earnings are on track!'}
                </p>
            </div>
            ...
            <div className="metrics-grid">
                <div className="metric-card">
                    <div className="metric-card__label">Expected Income</div>
                    <div className="metric-card__value">{formatCurrency(expected_income)}</div>
                </div>

                <div className="metric-card">
                    <div className="metric-card__label">Actual Income</div>
                ...
                <div className="metric-card">
                    <div className="metric-card__label">Compensation</div>
                ...
                <div className="metric-card">
                    <div className="metric-card__label">Income Loss</div>
            ...
            <div className="insight-card">
                <div className="insight-card__header">
                    <BrainIcon size={18} />
                    <span className="insight-card__label">AI Insight</span>
                </div>
